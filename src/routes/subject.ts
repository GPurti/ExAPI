...
import { delete_Subject,get_Subject,get_Subjects,matriculate_Subject,post_Subject, update_Subject,users_Subject } from "../controllers/subject";
...
router.get("/:idSubject/all",users_Subject);
export{router};
